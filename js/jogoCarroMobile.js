...
movimentarComClickPara1.addEventListener('click', posicao1);
let movimentarComClickPara2 = document.querySelector('#botaoCarroVerde');
movimentarComClickPara2.addEventListener('click', posicao2);
let movimentarComClickPara3 = document.querySelector('#botaoCarroAzul');
movimentarComClickPara3.addEventListener('click', posicao3);
let movimentarComClickPara4 = document.querySelector('#botaoCarroPreto');
movimentarComClickPara4.addEventListener('click', posicao4);
let movimentarComClickPara5 = document.querySelector('#botaoCarroAmarelo');
movimentarComClickPara5.addEventListener('click', posicao5);
